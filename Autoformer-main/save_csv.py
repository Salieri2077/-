...
# mat = scipy.io.loadmat('./data/ETT/KAU1_001.mat')
# mat = scipy.io.loadmat('./data/ETT/BCH1_001.mat')
mat = scipy.io.loadmat('./data/ETT/KAU2_001.mat')
y = np.array(mat['h'])
# 变成一列--单变量预测
num_row_time = 15
...
# y.to_csv('./data/ETT/KAU_Inpulse_hour.csv')
# y.to_csv('./data/ETT/BCH_Inpulse_hour.csv')
y.to_csv('./data/ETT/KAU2_Inpulse_hour.csv')
print('over')