...
import pandas as pd
import os
setting = '/NOF1/inpulse_tran_24'
# setting = '/NOF1/inpulse_tran_48'
# setting = '/NOF1/inpulse_tran_96'

# setting = 'inpulse_auto'
...
# plt.plot(pred_data.T, label='Transformer-Prediction')
# plt.legend()
# plt.show()
# # 绘制 origin_data 的伪彩图
# plt.figure(figsize=(10, 6))
...
# plt.colorbar(label='Value')
# plt.title('Transformer-Predicted Data Pseudocolor Plot')
# plt.xlabel('Delay')
# plt.ylabel('Time')
# plt.show()
